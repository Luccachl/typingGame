...
CREATE TABLE `ligas` (
  ...
  `nome_liga` varchar(100) DEFAULT NULL,
  `lider_id` int DEFAULT NULL,
  `senha` varchar(50) DEFAULT NULL,
  PRIMARY KEY (`id_L`),
  UNIQUE KEY `unique_nome_liga` (`nome_liga`),
  KEY `lider_id` (`lider_id`),
  CONSTRAINT `ligas_ibfk_1` FOREIGN KEY (`lider_id`) REFERENCES `usuarios` (`id_U`)
...
INSERT INTO `ligas` VALUES (5,'teste1',12,'teste'),(8,'eta',11,'eta');
